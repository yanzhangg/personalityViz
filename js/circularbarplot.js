class CircularBarplot {
    ...
    initVis() {
        ...
        vis.chartArea = vis.svg
            ...
            .attr(
                "transform",
                `translate(${vis.config.containerWidth / 2 + vis.config.margin.left},${vis.config.containerHeight / 2 + vis.config.margin.top})`
            );
        ...
        vis.chartArea.append('text')
            .attr('class', 'title')
            .attr('x', vis.name == "Conscientiousness" ? -60 : vis.name == "Openness" ? -35 : -45)
            .attr('y', -10)
            .attr('dy', '1em')
            .text(vis.name)
    ...
    renderVis() {
        ...
        vis.chart
            ...
            .on("mouseover", (event, d) => {
                d3
                    ...
                    <div class='tooltip-title'><b>Genre:</b> ${d.name.substring(0, d.name.length - 3)}</div>
        ...
        vis.chart.append("g")
            ...
            .attr("transform", function (d) { 
                return "rotate(" + ((vis.xScale(d.name) + vis.xScale.bandwidth() / 2) * 180 / Math.PI - 90) + ")" + "translate(" + (vis.yScale(d.sum) + 10) + ",0)"; })
            .append("text")
